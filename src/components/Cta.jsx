...
const BASE =
  'inline-flex items-center gap-2.5 font-sans uppercase tracking-[0.18em] text-xs md:text-[13px] px-7 py-3.5 rounded-full transition-colors duration-500'

/**
 * Un CTA porte l'action attendue à cet endroit précis de la page ; le second
 * bouton ouvre WhatsApp avec le message déjà écrit, pour ceux qui n'appelleront
 * jamais et n'écriront jamais un formulaire.
 */
export default function Cta({ label, href, messageWhatsapp, labelWhatsapp = 'WhatsApp', className = '' }) {
  ...
  return (
    <div className={'flex flex-wrap items-center gap-3 ' + className}>
      <a
        ...
        className={BASE + ' bg-or text-fond font-semibold hover:bg-or-clair'}
      >
        {label}
      </a>
